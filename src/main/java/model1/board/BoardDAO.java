...
public class BoardDAO extends JDBCConnect{
	...
	public int selectCount(Map<String, Object> map) { // 게시물 개수를 알려주는 메서드 정의
			// Map<String, Object> 컬렉션에는 게시물 검색을 위한 조건(검색어)가 담겨있음
		int totalCount = 0; // 결과 (게시물 수)를 담을 변수
		
		String query = "SELECT COUNT(*) FROM board"; // 게시물 개수를 얻어오는 쿼리문 작성
	...
	public List<BoardDTO> selectList(Map<String, Object> map){
		...
		try {
			...
			System.out.println("게시물 조회 중 예외 발생 노페이징");
			e.printStackTrace();
		}
		return bbs;
	}
	...
	// 지정한 배열에 값 넣기
	public void pushData(ArrayList<BoardDTO> a) {
		
//		List<BoardDTO> a = new ArrayList<BoardDTO>();
		// 결과 (게시물목록)을 담을 변수
